...
#include <random>
#include <algorithm>
#include "../float-forward-test/mnist/include/mnist/mnist_reader.hpp"

#include "FloatForwardProp.h"
...
const vector<int> netDimensions = {FloatForwardProp_SIZE_LAYER_0, FloatForwardProp_SIZE_LAYER_1, FloatForwardProp_SIZE_LAYER_2};

// Parallel input
const int inVecSize[] = {FloatForwardProp_IN_VEC_SIZE1, FloatForwardProp_IN_VEC_SIZE2};

// Parallel output
const int outVecSize[] = {FloatForwardProp_OUT_VEC_SIZE1, FloatForwardProp_OUT_VEC_SIZE2};
...
PropResult forward_prop_dfe(vector<vector<float>> input, int batchSize){
	...
	max_file = FloatForwardProp_init();
	...
	FloatForwardProp_actions_t actions;
	...
	FloatForwardProp_run(max_engine, &actions);
	struct timeval end;
...
{		
	...
	const string& folder = "src/float-forward-test/mnist";
