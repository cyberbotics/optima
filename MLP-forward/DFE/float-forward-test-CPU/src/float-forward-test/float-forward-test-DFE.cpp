...
const vector<int> netDimensions = {FloatForwardProp_SIZE_LAYER_0,
                                   FloatForwardProp_SIZE_LAYER_1,
                                   FloatForwardProp_SIZE_LAYER_2};

// Parallel input
const int inVecSize[] = {FloatForwardProp_IN_VEC_SIZE1,
                         FloatForwardProp_IN_VEC_SIZE2};

// Parallel output
const int outVecSize[] = {FloatForwardProp_OUT_VEC_SIZE1,
                          FloatForwardProp_OUT_VEC_SIZE2};
