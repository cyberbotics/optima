/**\file */
#ifndef SLIC_DECLARATIONS_ForwardProp_H
#define SLIC_DECLARATIONS_ForwardProp_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define ForwardProp_SIZE_LAYER_2 (10)
#define ForwardProp_SIZE_LAYER_0 (784)
#define ForwardProp_DYNAMIC_CLOCKS_ENABLED (0)
#define ForwardProp_SIZE_LAYER_1 (64)
#define ForwardProp_PCIE_ALIGNMENT (16)
 ...
 */
int ForwardProp_get_FHIDDENLAYER_KERNEL_offset( void );

/**
 * \brief Auxiliary function to evaluate expression for "FOUTPUTLAYER_KERNEL.offset".
 */
int ForwardProp_get_FOUTPUTLAYER_KERNEL_offset( void );
 ...
 * \param [in] instream_biases1 The stream should be of size (param_BS * 256) bytes.
 * \param [in] instream_biases2 The stream should be of size (param_BS * 40) bytes.
 ...
 */
max_run_t *ForwardProp_nonblock(
	int64_t param_BS,
	const float *instream_biases1,
	const float *instream_biases2,
	const float *instream_input,
...
typedef struct { 
	...
	const float *instream_biases1; /**<  [in] The stream should be of size (param_BS * 256) bytes. */
	const float *instream_biases2; /**<  [in] The stream should be of size (param_BS * 40) bytes. */
 ...
 */
void ForwardProp_run(
	max_engine_t *engine,
	ForwardProp_actions_t *interface_actions);
 ...
 */
max_run_t *ForwardProp_run_nonblock(
	max_engine_t *engine,
	ForwardProp_actions_t *interface_actions);
 ...
 */
void ForwardProp_run_group(max_group_t *group, ForwardProp_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ForwardProp_run_group_nonblock(max_group_t *group, ForwardProp_actions_t *interface_actions);
 ...
 */
void ForwardProp_run_array(max_engarray_t *engarray, ForwardProp_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ForwardProp_run_array_nonblock(max_engarray_t *engarray, ForwardProp_actions_t *interface_actions[]);
 ...
 */
max_actions_t* ForwardProp_convert(max_file_t *maxfile, ForwardProp_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* ForwardProp_init(void);

/* Error handling functions */
int ForwardProp_has_errors(void);
const char* ForwardProp_get_errors(void);
void ForwardProp_clear_errors(void);
/* Free statically allocated maxfile data */
void ForwardProp_free(void);
/* returns: -1 = error running command; 0 = no error reported */
int ForwardProp_simulator_start(void);
/* returns: -1 = error running command; 0 = no error reported */
int ForwardProp_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_ForwardProp_H */
